    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', color: 'var(--text)' }}>
      ...
      <div className="dashLayout">
        ...
        <aside className="sidebar">
          ...
          <a href="#my-videos" className="sidebarLink" onClick={e => { e.preventDefault(); document.getElementById('my-videos')?.scrollIntoView({ behavior: 'smooth' }); }}>
          ...
          <a href="#earnings" className="sidebarLink" onClick={e => { e.preventDefault(); document.getElementById('earnings')?.scrollIntoView({ behavior: 'smooth' }); }}>
        ...
        <div className="dashContent">
          ...
          {/* Earnings section */}
          {earnings && (
            <div id="earnings" style={{ marginBottom: '48px' }}>
          ...
          {/* My Videos */}
          <div id="my-videos" style={{ marginBottom: '48px' }}>
